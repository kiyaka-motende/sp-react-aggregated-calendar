...
var spservices = /** @class */ (function () {
    ...
    spservices.prototype.getEvents = function (siteUrl, listTitle, eventStartDate, eventEndDate) {
        return __awaiter(this, void 0, void 0, function () {
            var events, parseEvt, web, results_1, event_1, mapEvents, error_4;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        results_1 = _a.sent();
                        if (!(results_1 && results_1.Row.length > 0)) return [3 /*break*/, 4];
                        event_1 = "";
                        mapEvents = function () { return __awaiter(_this, void 0, void 0, function () {
                            var _i, _a, eventDate, endDate, initialsArray, initials, attendees, first, last, geo, geolocation, isAllDayEvent, isRecurring, _b, _c, attendee, _d, _e, _f, _g, _h, _j, _k, _l;
                            var _m;
                            return __generator(this, function (_o) {
                                switch (_o.label) {
                                    ...
                                    case 3:
                                        ...
                                        isRecurring = event_1["fRecurrence.value"] === "1";
                                    ...
                                    case 4:
                                        _m.title = _o.sent(),
                                            ...
                                            _m.RecurrenceData = event_1.RecurrenceData,
                                            _m.allDay = isAllDayEvent;
                                        if (!isRecurring) return [3 /*break*/, 10];
