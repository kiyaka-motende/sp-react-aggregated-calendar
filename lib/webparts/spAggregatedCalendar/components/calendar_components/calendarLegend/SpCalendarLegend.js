...
export var SpCalendarLegend = function (props) {
    ...
    calendarLegend = props.selectedCalendarLists.map(function (calendar) {
        ...
        return (React.createElement("div", { className: "".concat(styles.outerLegendDiv, " ").concat(outerClass), title: calendar.CalendarTitle },
            React.createElement("div", { className: styles.innerLegendDiv, style: calendarLegendColor, onClick: function (e) {
                    setisCalendarFiltered(!isCalendarFiltered);
                    setSelectedCalendar(calendar.CalendarListTitle);
                } }),
            calendar.CalendarTitle));
    });
    return (React.createElement("div", null, calendarLegend));
};
